namespace TempoDigitalApex3.Migrations
{
    ...
    public partial class YoutubeFullReport_Added : DbMigration
    {
        public override void Up()
        {
            return;
            CreateTable(
                "dbo.YT_Reports_Music_Full",
                c => new
                    {
        ...
        {
            return;
            DropForeignKey("dbo.YT_Reports_Music_Full", "YoutubeChannel_ID", "dbo.YoutubeChannels");
            DropIndex("dbo.YT_Reports_Music_Full", new[] { "YoutubeChannel_ID" });
            DropTable("dbo.YT_Reports_Music_Full");
        }
    }
}
