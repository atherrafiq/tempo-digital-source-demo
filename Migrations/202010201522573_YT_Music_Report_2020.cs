namespace TempoDigitalApex3.Migrations
{
    ...
    public partial class YT_Music_Report_2020 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.YT_Reports_Music_2020",
                c => new
                    {
        ...
        {
            DropForeignKey("dbo.YT_Reports_Music_2020", "YoutubeChannel_ID", "dbo.YoutubeChannels");
            DropIndex("dbo.YT_Reports_Music_2020", new[] { "YoutubeChannel_ID" });
            DropTable("dbo.YT_Reports_Music_2020");
        }
    }
}
