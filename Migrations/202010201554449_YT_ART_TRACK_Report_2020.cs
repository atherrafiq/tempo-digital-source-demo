namespace TempoDigitalApex3.Migrations
{
    ...
    public partial class YT_ART_TRACK_Report_2020 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.YT_ART_TRACK_Report_2020",
                c => new
                    {
        ...
        {
            DropForeignKey("dbo.YT_ART_TRACK_Report_2020", "YoutubeChannel_ID", "dbo.YoutubeChannels");
            DropIndex("dbo.YT_ART_TRACK_Report_2020", new[] { "YoutubeChannel_ID" });
            DropTable("dbo.YT_ART_TRACK_Report_2020");
        }
    }
}
