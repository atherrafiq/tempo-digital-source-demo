$(document).ready( function(){
    ...
    ********************************/
    ...
    $('.cz-bg-color span').on('click',function(){
        ...
        if(bgColor == 'white'){
            $('.logo-img img').attr('src','~/Content/~/Content/app-assets/img/logo-dark.png');
        }
        else{
            if($('.logo-img img').attr('src') == '~/Content/~/Content/app-assets/img/logo-dark.png'){
                $('.logo-img img').attr('src','~/Content/~/Content/app-assets/img/logo.png');
            }
        }
    });
