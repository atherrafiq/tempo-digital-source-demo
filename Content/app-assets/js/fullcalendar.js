...
$(document).ready(function(){
	...
	************************************/
	$('#fc-json').fullCalendar({
		...
		eventLimit: true, // allow "more" link when too many events
		events: {
			url: '~/Content/~/Content/~/Content/app-assets/data/fullcalendar/php/get-events.php',
			error: function() {
				$('#script-warning').show();
			}
		},
	...
	****************************************/
	...
	$.getJSON('~/Content/~/Content/~/Content/app-assets/data/fullcalendar/php/get-timezones.php', function(timezones) {
